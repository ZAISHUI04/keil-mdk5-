...
typedef struct
{
    ...
    int16_t last_ecd;       //上一个编码器数据
		int16_t round_cnt;      //圈数计数
		int16_t total_angle;    //总角度
		uint16_t offset_ecd;    //编码器偏移量
...
extern void CAN_cmd_2ff_gimbal(int16_t motor_209, int16_t motor_20A, int16_t motor_20B, int16_t no_motor);
/**
...
extern const motor_measure_t *new_motor(void);
